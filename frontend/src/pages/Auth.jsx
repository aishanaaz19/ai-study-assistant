...
const Auth = () => {
  ...
  // Enhanced Google Sign-In Setup (your original code)
  useEffect(() => {
    let mounted = true;
  ...
  // Frontend validation (your original code)
  const validateForm = () => {
  const newErrors = {};
  ...
  } else if (!emailRegex.test(formData.email)) { // Fixed this line
