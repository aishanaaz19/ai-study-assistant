...
const Signup = () => {
  ...
  return (
    <div className="w-screen h-screen flex">
      ...
      {/* Left Side - Form (Black with Stars) */}
      <div className="w-1/2 bg-black text-white relative flex flex-col justify-center items-center p-12">
